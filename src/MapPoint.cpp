...
#else
    cv::Mat P0 = pKF0->Tcw.rowRange(0,3);
    cv::Mat P1 = pKF->Tcw.rowRange(0,3);
    Point2f pt0 = pKF0->keyPointsNormPlane[mObservations[pKF0]];
    Point2f pt1 = pKF->keyPointsNormPlane[mObservations[pKF]];
#endif
...
#ifdef USING_NORM_PLANE
    return mMainKF->keyPointsNormPlane[mObservations[mMainKF]];
#else
